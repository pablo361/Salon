...
public class ActivityTipoProductos extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String idProd = sharedPreferences.getString("idTipoProducto","");
        String title = sharedPreferences.getString("tipoNombre","");
        MaterialToolbar toolbar = (MaterialToolbar) findViewById(R.id.toolbar);
        TextView tvt = (TextView) toolbar.findViewById(R.id.toolbar_title);
        tvt.setText(title);
        RequestParams params = new RequestParams();
        params.add("type","getTipoProd");
        params.add("idTipoProducto",idProd);
        clsWebRequest.post(this,"apiSalon.php",params,new ActivityTipoProductos.ResponseHandler());
    }
